...
/* Còi báo Buzzer chủ động */
#define BUZZER_PORT             GPIOB
#define BUZZER_PIN              1       /* PB1, mức HIGH phát tiếng */

/* ========================================================================== */
/* BA CẢM BIẾN SIÊU ÂM CỦA REVERSE ASSIST                                   */
/* ========================================================================== */

/* Cảm biến giữa phía trước */
#define SONAR_FRONT_TRIG_PORT          GPIOA
#define SONAR_FRONT_TRIG_PIN           4U      /* PA4 */
#define SONAR_FRONT_ECHO_PORT          GPIOB
#define SONAR_FRONT_ECHO_PIN           2U      /* PB2 / EXTI2 */

/* Cảm biến phía sau bên trái */
#define SONAR_REAR_LEFT_TRIG_PORT      GPIOA
#define SONAR_REAR_LEFT_TRIG_PIN       5U      /* PA5 */
#define SONAR_REAR_LEFT_ECHO_PORT      GPIOB
#define SONAR_REAR_LEFT_ECHO_PIN       3U      /* PB3 / EXTI3 */

/* Cảm biến phía sau bên phải */
#define SONAR_REAR_RIGHT_TRIG_PORT     GPIOB
#define SONAR_REAR_RIGHT_TRIG_PIN      7U      /* PB7 */
#define SONAR_REAR_RIGHT_ECHO_PORT     GPIOB
#define SONAR_REAR_RIGHT_ECHO_PIN      4U      /* PB4 / EXTI4 */
